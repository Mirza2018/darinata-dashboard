...
const FindCarTable = ({ data, loading, meta, onPageChange }) => {
  // console.log(data);
  const [deleteCar] = useDeleteFindCarMutation();
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "color",
      render: (text) => (
        <div className="whitespace-nowrap">{text.join(", ") || "-"}</div>
      ),
    },
