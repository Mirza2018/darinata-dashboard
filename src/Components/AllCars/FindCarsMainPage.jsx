...
import { useAllCarListQuery, useFindCarListQuery } from "../../redux/api/adminApi";
import AllCarTable from "./AllCarTable";
import FindCarTable from "./FindCarTable";

const FindCarsMainPage = () => {
...
export default FindCarsMainPage;
